...
model.push_to_hub("VanshajR/roberta-emotion-7class")
print("✅ Model uploaded")

print("\n[3/4] Pushing tokenizer to HuggingFace Hub...")
tokenizer.push_to_hub("VanshajR/roberta-emotion-7class")
print("✅ Tokenizer uploaded")

print("\n[4/4] Upload complete!")
print("=" * 60)
print("✅ Emotion Classifier uploaded successfully!")
print(f"🔗 Model URL: https://huggingface.co/VanshajR/roberta-emotion-7class")
print("\nNext steps:")
